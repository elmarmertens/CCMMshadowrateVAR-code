...
\begin{table}
	...
	\label{tab:oos:ExYields:2017-12}
	\begin{small}
		\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD20exYield-2022-09-Standard-p12-vs-shadowrateGeneralVAR-p12-vs-nonstructuralVAR-p12-evalStart201001evalEnd201712.tex}
	\end{small}
\end{table}


\begin{table}
	\caption{Forecast performance of shadow-rate VARs w/multiple interest rates}
	\label{tab:oos:WithYields:2017-12}
	\begin{small}
	\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD20-2022-09-Standard-p12-vs-nonstructuralVAR-p12-vs-blocknonstructuralVAR-p12-evalStart201001evalEnd201712.tex}
	\end{small}
\end{table}

\begin{table}
	\caption{Shadow-rate VARs compared against a linear VAR w/o short-term interest rates}
	\label{tab:oos:OnlyLongYields:2017-12}
	\begin{small}
	\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD14longyields-2022-09-standardVAR-p12-vs-nonstructuralVAR-p12-vs-BlocknonstructuralVAR-p12-evalStart201001evalEnd201712.tex}
	\end{small}
\end{table}
...
\begin{table}
	...
	\begin{small}
	\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD20exYield-2022-09-Standard-p12-vs-shadowrateGeneralVAR-p12-vs-nonstructuralVAR-p12-evalStart201001evalEnd202208.tex}
	\end{small}
\end{table}
...
\begin{table}
	...
	\begin{small}
	\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD20-2022-09-Standard-p12-vs-nonstructuralVAR-p12-vs-blocknonstructuralVAR-p12-evalStart201001evalEnd202208.tex}
	\end{small}
\end{table}
...
\begin{table}
	...
	\begin{small}
	\input{\imagesandtables/tripleComparisonQEwSE-fredsxMD14longyields-2022-09-standardVAR-p12-vs-nonstructuralVAR-p12-vs-BlocknonstructuralVAR-p12-evalStart201001evalEnd202208.tex}
	\end{small}
\end{table}
