...
- [oosEvaluationTablesSE.m](oosEvaluationTablesSE.m) and [oosEvaluationTablesAgainstLongYieldsOnlySE.m](oosEvaluationTablesAgainstLongYieldsOnlySE.m) produce additional forecast comparison tables, which report standard errors on differences in average errors and density scores that are discussed in the the supplement to the paper.
...
For the supplementary appendix, we have the follwing material:

| Figure/Table    | Program                  | Line Number | Output file                      | Note                            |
|-------------------|--------------------------|-------------|----------------------------------|---------------------------------|
| Table 1 | [oosEvaluationTablesSE.m](oosEvaluationTablesSE.m)| 328 |tripleComparisonQEwSE-fredsxMD20exYield-2022-09-Standard-p12-vs-shadowrateGeneralVAR-p12-vs-nonstructuralVAR-p12-evalStart201001evalEnd201712.tex |     supplement |
| Table 2 | [oosEvaluationTablesSE.m](oosEvaluationTablesSE.m)| 328 |tripleComparisonQEwSE-fredsxMD20-2022-09-Standard-p12-vs-nonstructuralVAR-p12-vs-blocknonstructuralVAR-p12-evalStart201001evalEnd201712.tex |          supplement |
| Table 3 | [oosEvaluationTablesAgainstLongYieldsOnlySE.m](oosEvaluationTablesAgainstLongYieldsOnlySE.m)| 255 |tripleComparisonQEwSE-fredsxMD14longyields-2022-09-standardVAR-p12-vs-nonstructuralVAR-p12-vs-BlocknonstructuralVAR-p12-evalStart201001evalEnd201712.tex |       supplement |
| Table 4 | [oosEvaluationTablesSE.m](oosEvaluationTablesSE.m)| 328 |tripleComparisonQEwSE-fredsxMD20exYield-2022-09-Standard-p12-vs-shadowrateGeneralVAR-p12-vs-nonstructuralVAR-p12-evalStart201001evalEnd202208.tex |     supplement |
| Table 5 | [oosEvaluationTablesSE.m](oosEvaluationTablesSE.m)| 328 |tripleComparisonQEwSE-fredsxMD20-2022-09-Standard-p12-vs-nonstructuralVAR-p12-vs-blocknonstructuralVAR-p12-evalStart201001evalEnd202208.tex |          supplement |
| Table 6 | [oosEvaluationTablesAgainstLongYieldsOnlySE.m](oosEvaluationTablesAgainstLongYieldsOnlySE.m)| 255 |tripleComparisonQEwSE-fredsxMD14longyields-2022-09-standardVAR-p12-vs-nonstructuralVAR-p12-vs-BlocknonstructuralVAR-p12-evalStart201001evalEnd202208.tex |       supplement |
| Figure 1 , Panel a | [showPAIchanges.m](showPAIchanges.m) | 174ff | PAI-intercept-standardVARAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 1 , Panel b | [showPAIchanges.m](showPAIchanges.m) | 174ff | PAI-intercept-ELBblocknonstructuralAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 1 , Panel c | [showPAIchanges.m](showPAIchanges.m) | 212ff | PAI-lag1-standardVARAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 1 , Panel d | [showPAIchanges.m](showPAIchanges.m) | 212ff | PAI-lag1-ELBblocknonstructuralAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 1 , Panel e | [showPAIchanges.m](showPAIchanges.m) | 251ff | PAI-lagOTHER-standardVARAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 1 , Panel f | [showPAIchanges.m](showPAIchanges.m) | 251ff | PAI-lagOTHER-ELBblocknonstructuralAR1SV-fredsxMD20-2022-09 | supplement |
| Figure 2 , Panel a | [showPAIchanges.m](showPAIchanges.m) | 174ff | PAI-intercept-standardVARAR1SV-fredsxMD20exYield-2022-09 | supplement |
| Figure 2 , Panel b | [showPAIchanges.m](showPAIchanges.m) | 174ff | PAI-intercept-ELBblocknonstructuralAR1SV-fredsxMD20exYield-2022-09 | supplement |
| Figure 2 , Panel c | [showPAIchanges.m](showPAIchanges.m) | 212ff | PAI-lag1-standardVARAR1SV-fredsxMD20exYield-2022-09 | supplement |
| Figure 2 , Panel d | [showPAIchanges.m](showPAIchanges.m) | 212ff | PAI-lag1-ELBblocknonstructuralAR1SV-fredsxMD20exYield-2022-09 | supplement |
| Figure 2 , Panel e | [showPAIchanges.m](showPAIchanges.m) | 251ff | PAI-lagOTHER-standardVARAR1SV-fredsxMD20exYield-2022-09 | supplement |
| Figure 2 , Panel f | [showPAIchanges.m](showPAIchanges.m) | 251ff | PAI-lagOTHER-ELBblocknonstructuralAR1SV-fredsxMD20exYield-2022-09 | supplement |
