...
for this = {...
        'fredblockMD20', 'fredblockMD20exYield', ...
        'fredblockMD20EBP', 'fredblockMD20EBPexYield', ...
        'fredblockMD20krippner', 'fredblockMD20wuxia', ... 
        ...
        % 'fredMD5', 'fredMD5yields', ...
        % 'fredMD6', 'fredMD6yields', ...
        % 'fredMDmid', 'fredMDmidYields', ...
        }
    ...
    %% patch in PCE core and Services Consumption from current FRED
    for FREDid = {'PCEPILFE', 'DSERRA3M086SBEA'}
        fred               = fredreadcsv(FREDid{:});
        fredseries         = NaN(size(rawdata,1), 1);
        [~, ndx1, ndx2]    = intersect(dates, fred.DATES);
        fredseries(ndx1,1) = fred.VALUES(ndx2);
        rawdata            = [rawdata, fredseries]; %#ok<AGROW>
        names              = cat(2, names, FREDid{:});
        tcode              = [tcode, 5]; %#ok<AGROW>
    end
    ...
    switch datalabel
        ...
        case {'fredMD5'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA', 'DSERRG3M086SBEA', 'PCEPI', 'FEDFUNDS'};
        case {'fredMD5yields'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA', 'DSERRG3M086SBEA', 'PCEPI', 'FEDFUNDS', ...
                'TB6MS', 'GS1', ...
                'GS5', 'GS10'};
        case {'fredMD6'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA', 'RETAILx', 'DSERRG3M086SBEA', 'PCEPI', 'FEDFUNDS'};
        case {'fredMD6yields'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA',  'RETAILx','DSERRG3M086SBEA', 'PCEPI', 'FEDFUNDS', ...
                'TB6MS', 'GS1', ...
                'GS5', 'GS10'};
        case {'fredMDmid'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA', 'DSERRA3M086SBEA', 'DSERRG3M086SBEA', 'PCEPI', 'PCEPILFE', 'FEDFUNDS'};
        case {'fredMDmidYields'}
            codeVariableSelection = {'UNRATE', 'PAYEMS', 'DPCERA3M086SBEA',  'DSERRA3M086SBEA', 'DSERRG3M086SBEA', 'PCEPI', 'PCEPILFE', 'FEDFUNDS', ...
                'TB6MS', 'GS1', ...
                'GS5', 'GS10'};
        case {'fredMD20'}
        ...
        case {'fredblockMD20'}
            codeVariableSelection = {'RPI', 'DPCERA3M086SBEA', 'INDPRO', ...
                ...
                'GS5', 'GS10', ...
                'BAA'};
        case {'fredblockMD20exYield'}
            codeVariableSelection = {'RPI', 'DPCERA3M086SBEA', 'INDPRO', ...
                'CUMFNS', 'UNRATE', 'PAYEMS', 'CES0600000007', 'CES0600000008', 'WPSFD49207', ...
                'PPICMM', 'PCEPI', 'HOUST', 'S&P 500', 'EXUSUKx', ...
                'FEDFUNDS'};
        case {'fredblockMD20EBP'}
