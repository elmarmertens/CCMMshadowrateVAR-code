...
mcmc = matfile(fullfile(resultsdir, sprintf('mcmcHybrid-%s', titlename)));
...
for IRF1scale = irfSCALES
    ...
    for irfDate = irfDATES
        ...
        parfor mm = 1 : MCMCdraws
            ...
            simfun = @(nushocks) simVARhybrid(nushocks, N, fcstX0, ndxfcstY, ndxfcstActual, ndxfcstShadow, cumcode, np, fcstA, fcstB, invAdraws(:,:,mm), ...
                ELBbound, ndxYIELDS, irfHorizon, irfNdraws);
        ...
        save(sprintf('irf2Hybrid-%s.mat', titlename), '-v7.3')
...
function ydraws = simVARhybrid(nushocks, N, fcstX0, ndxfcstY, ndxfcstActual, ndxfcstShadow,  cumcode, np, fcstA, fcstB, invA, ELBbound, ndxYIELDS, irfHorizon, irfNdraws)
