%% Block-hybrid VAR of <<Forecasting with Shadow-Rate VARs>> with Switching A at ELB
...
modellabel = sprintf('ELBblockhybridAelbPrec%d', floor(precisionAelb * 10));
...
parfor ndxT = 1 : Njumpoffs % parfor
    ...
    [PAI_all, PHI_all, invA_all, invAelb_all, sqrtht_all, shadowrate_all, missingrate_all, ...
        ydraws, yhat, ...
        shadowratedraws, shadowratehat, ...
		logscoredraws, ...
        logscoreXdraws, logscoreIdraws ...
        ] = mcmcVARshadowrateBlockHybridAelb(thisT, MCMCdraws, p, np, data, ydates, ...
        actualrateBlock, ...
        ...
        [], [], ... % IRF
        yrealized, fcstNdraws, fcstNhorizons, rndStreams{TID}, false); %#ok<PFBNS>
