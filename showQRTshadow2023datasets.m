...
for MODELTYPE = {'ELBsampling', 'ELBblockhybrid'}
    ...
    wrapthisfigure(thisfig, sprintf('%s%d-QRTp%d-all-%s%s', shadowshortlabel, thisShadow, p, modeltype, ELBtag), wrap)
    hl = legend(hshadow, {DATA.prettylabel}, 'location', 'southoutside');
    hl.NumColumns = 3;
    wrapthisfigure(thisfig, sprintf('%s%d-QRTp%d-all-%s%s-WITHLEGEND', shadowshortlabel, thisShadow, p, modeltype, ELBtag), wrap)
    ...
    wrapthisfigure(thisfig, sprintf('%s%d-FINALp%d-all-%s%s', shadowshortlabel, thisShadow, p, modeltype, ELBtag), wrap)
    hl = legend(hshadow, {DATA.prettylabel}, 'location', 'southoutside');
    hl.NumColumns = 3;
    wrapthisfigure(thisfig, sprintf('%s%d-FINALp%d-all-%s%s-WITHLEGEND', shadowshortlabel, thisShadow, p, modeltype, ELBtag), wrap)
